  ...
  const roadmapItems = [
    {
      ...
      description:
        "Dive deeper into your data with our new analytics features.",
      status: "completed",
      date: "Q2 2023",
    },
    {
    ...
    },
    {
      ...
      description:
        "Work seamlessly with your team using our new collaboration features.",
      status: "planned",
      date: "Q1 2024",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            See what we&apos;re working on and what&apos;s coming next to make
